...
plot(lambda_nm,I_new,type="o",xlab='Wavelength (nm)',ylab='Spectral Emittance (W/m^2/nm)',main='Part #2: Equation 1')
```
...
If we were to calculate the total power for the entire band of wavelenghts we would get:
```{r}
T2 = 6000
lambda2 = seq(3.4e-7,8.05e-7, by=1e-10)
y2 = (h*c)/(lambda2*k*T2)
I2=((2*pi)*(h)*(c**2)/((lambda2**5)*(exp(y2)-1)))
plot(lambda2,I2,xlab='Wavelength (m)',ylab='Spectral Emittance (W/m^2/m)',main='Part #1: Equation 2')
